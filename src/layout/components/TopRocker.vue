              ...
              <div class="header-message-list">
                <a class="dropdown-item" href="javascript:;">
                  <div class="d-flex align-items-center">
                    <div class="user-online">
                      <img
                        src="../../assets/assets/images/avatars/avatar-1.png"
                        class="msg-avatar"
                        alt="user avatar"
                      />
                    </div>
                ...
                <a class="dropdown-item" href="javascript:;">
                  <div class="d-flex align-items-center">
                    <div class="user-online">
                      <img
                        src="../../assets/assets/images/avatars/avatar-3.png"
                        class="msg-avatar"
                        alt="user avatar"
                      />
                    </div>
                ...
                <a class="dropdown-item" href="javascript:;">
                  <div class="d-flex align-items-center">
                    <div class="user-online">
                      <img
                        src="../../assets/assets/images/avatars/avatar-4.png"
                        class="msg-avatar"
                        alt="user avatar"
                      />
                    </div>
                ...
                <a class="dropdown-item" href="javascript:;">
                  <div class="d-flex align-items-center">
                    <div class="user-online">
                      <img
                        src="../../assets/assets/images/avatars/avatar-5.png"
                        class="msg-avatar"
                        alt="user avatar"
                      />
                    </div>
                ...
                <a class="dropdown-item" href="javascript:;">
                  <div class="d-flex align-items-center">
                    <div class="user-online">
                      <img
                        src="../../assets/assets/images/avatars/avatar-6.png"
                        class="msg-avatar"
                        alt="user avatar"
                      />
                    </div>
                ...
                <a class="dropdown-item" href="javascript:;">
                  <div class="d-flex align-items-center">
                    <div class="user-online">
                      <img
                        src="../../assets/assets/images/avatars/avatar-7.png"
                        class="msg-avatar"
                        alt="user avatar"
                      />
                    </div>
                ...
                <a class="dropdown-item" href="javascript:;">
                  <div class="d-flex align-items-center">
                    <div class="user-online">
                      <img
                        src="../../assets/assets/images/avatars/avatar-8.png"
                        class="msg-avatar"
                        alt="user avatar"
                      />
                    </div>
                ...
                <a class="dropdown-item" href="javascript:;">
                  <div class="d-flex align-items-center">
                    <div class="user-online">
                      <img
                        src="../../assets/assets/images/avatars/avatar-9.png"
                        class="msg-avatar"
                        alt="user avatar"
                      />
                    </div>
                ...
                <a class="dropdown-item" href="javascript:;">
                  <div class="d-flex align-items-center">
                    <div class="user-online">
                      <img
                        src="../../assets/assets/images/avatars/avatar-10.png"
                        class="msg-avatar"
                        alt="user avatar"
                      />
                    </div>
                ...
                <a class="dropdown-item" href="javascript:;">
                  <div class="d-flex align-items-center">
                    <div class="user-online">
                      <img
                        src="../../assets/assets/images/avatars/avatar-11.png"
                        class="msg-avatar"
                        alt="user avatar"
                      />
                    </div>
