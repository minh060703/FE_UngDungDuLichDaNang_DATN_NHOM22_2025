                ...
                <div class="modal-body">
                    <div class="content p-5 px-3 text-center">
                        ...
                        <div class="modal-footer-btn mt-3 d-flex justify-content-center mt-5">
                            ...
                            <button type="submit" class="btn btn-primary fs-13 fw-medium p-2 px-3" @click="xoa_san_pham"
...
export default {
    ...
    mounted() {
        // khi mở modal thì sẽ reset form lại để không lưu dữ liệu cũ
